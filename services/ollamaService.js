/**
 * OpenAI API Service for AI Chat Integration - Node.js Version
...
class OpenAIService {
  constructor() {
    this.model = process.env.OPENAI_MODEL || 'llm_model'
    this.apiKey = process.env.OPENAI_API_KEY || 'dummy-key' // Some OpenAI-compatible APIs don't require a real key
