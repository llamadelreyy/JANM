  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'bot',
      content: 'Selamat datang! Saya adalah pembantu AI yang menggunakan model Qwen3-14B dengan akses kepada database Kementerian Dalam Negeri. Bagaimana saya boleh membantu anda hari ini?',
      timestamp: new Date()
    }
  ])
