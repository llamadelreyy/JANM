  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'bot',
      content: `Selamat datang ${userName}! Saya adalah UPSI Bot. Bagaimana saya boleh membantu anda hari ini?`,
      timestamp: new Date()
    }
  ])
    ...
    setMessages([
      {
        id: 1,
        type: 'bot',
        content: `Selamat datang ${userName}! Saya adalah pembantu AI yang menggunakan model Qwen3-235B dengan akses kepada database UPSI. Bagaimana saya boleh membantu anda hari ini?`,
        timestamp: new Date()
      }
    ])
  }
        ...
        <div className={cn(
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className={cn(
              ...
              {isConnected ? 'Connected to UPSI Database' : 'Tidak tersambung'}
            </span>
            {connectionError && (
