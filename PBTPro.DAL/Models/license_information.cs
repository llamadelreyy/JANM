...
/// </summary>
public partial class license_information
{
    ...
    public virtual ICollection<license_address_swap> license_address_swaps { get; set; } = new List<license_address_swap>();

    public virtual ICollection<license_holder> license_holders { get; set; } = new List<license_holder>();

    public virtual ICollection<license_location> license_locations { get; set; } = new List<license_location>();

    public virtual ICollection<license_medium> license_media { get; set; } = new List<license_medium>();
