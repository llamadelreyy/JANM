...
/// <summary>
/// This table stores the different statuses for each tax (status cukai) (e.g., Cukai Dibayar, Cukai Tertunggak).
/// </summary>
public partial class ref_tax_status
{
    /// <summary>
    /// Unique identifier for each tax status record (Primary Key).
    /// </summary>
    public int status_id { get; set; }

    /// <summary>
    /// Name of the tax status (e.g., Cukai Dibayar, Cukai Tertunggak).
    /// </summary>
