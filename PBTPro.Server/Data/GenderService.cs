...
namespace PBTPro.Data
{
    ...
    public class GenderService : IDisposable
    {
        ...
        public async Task<List<ref_gender>> ListAll()
        {
            ...
            try
            {
                if (response.ReturnCode == 200)
                {
                    ...
                    await _cf.CreateAuditLog((int)AuditType.Information, GetType().Name + " - " + MethodBase.GetCurrentMethod().Name, "Papar semula senarai tetapan jantina.", 1, LoggerName, "");
                }
                else
                {
        ...
        {
            var result = _cf.CreateAuditLog((int)AuditType.Information, GetType().Name + " - " + MethodBase.GetCurrentMethod().Name, "Berjaya muat semula senarai tetapan jantina.", 1, LoggerName, "");
