...
namespace PBTPro.Data
{
    ...
    public class RefTrnStatusService : IDisposable
    {
        ...
        private string _baseReqURL = "/api/RefTrnStatus";
        ...
        public RefTrnStatusService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, ILogger<RefTrnStatusService> logger, PBTProDbContext dbContext, ApiConnector apiConnector, PBTAuthStateProvider PBTAuthStateProvider)
        {
        ...
        [HttpGet]
        public async Task<List<ref_trn_status>> ListAll()
        {
            var result = new List<ref_trn_status>();
            ...
            try
            {
                if (response.ReturnCode == 200)
                {
                    ...
                    {
                        result = JsonConvert.DeserializeObject<List<ref_trn_status>>(dataString);
                    }
            ...
            catch (Exception ex)
            {
                ...
                result = new List<ref_trn_status>();
            }
            return result;
        }
    }
