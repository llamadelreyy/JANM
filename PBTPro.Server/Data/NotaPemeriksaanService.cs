...
{
    public class NotaPemeriksaanService : IDisposable
    {
        ...
        private readonly ILogger<NotaPemeriksaanService> _logger;
        private readonly ApiConnector _apiConnector;
        private readonly PBTAuthStateProvider _PBTAuthStateProvider;

        private string _baseReqURL = "/api/NotaPemeriksaan";
        ...
        public NotaPemeriksaanService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, ILogger<NotaPemeriksaanService> logger, PBTProDbContext dbContext, ApiConnector apiConnector, PBTAuthStateProvider PBTAuthStateProvider)
        {
