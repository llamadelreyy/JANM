...
namespace PBTPro.Data
{
    public class UserService : IDisposable
    {
        ...
        private List<ApplicationUser> _User { get; set; }
        ...
        public async Task<List<ApplicationUser>> ListAll()
        {
            ...
            try
            {
                if (response.ReturnCode == 200)
                {
                    ...
                    await _cf.CreateAuditLog((int)AuditType.Information, GetType().Name + " - " + MethodBase.GetCurrentMethod().Name, "Papar senarai pengguna sistem.", 1, LoggerName, "");
                }
                else
                {
        ...
        public async Task<List<ApplicationUser>> Refresh()
        {
            ...
            try
            {
                ...
                if (response.ReturnCode == 200)
                {
                    ...
                    await _cf.CreateAuditLog((int)AuditType.Information, GetType().Name + " - " + MethodBase.GetCurrentMethod().Name, "Papar semula senarai pengguna sistem.", 1, LoggerName, "");
                }
                else
                {
                    await _cf.CreateAuditLog((int)AuditType.Error, GetType().Name + " - " + MethodBase.GetCurrentMethod().Name, "Ralat - Status Kod : " + response.ReturnCode, 1, LoggerName, "");
        ...
        public async Task<ReturnViewModel> Add(ApplicationUser inputModel)
        {
            ...
            try
            {
                ...
                result = response;
                await _cf.CreateAuditLog((int)AuditType.Information, GetType().Name + " - " + MethodBase.GetCurrentMethod().Name, "Berjaya tambah data untuk pengguna sistem.", 1, LoggerName, "");
            }
            catch (Exception ex)
            {
        ...
        public async Task<ReturnViewModel> Update(int id, ApplicationUser inputModel)
        {
            ...
            try
            {
                ...
                result = response;
                await _cf.CreateAuditLog((int)AuditType.Information, GetType().Name + " - " + MethodBase.GetCurrentMethod().Name, "Berjaya kemaskini data untuk pengguna sistem.", 1, LoggerName, "");
        ...
        public async Task<ReturnViewModel> Delete(int id)
        {
            ...
            try
            {
                ...
                result = response;
                await _cf.CreateAuditLog((int)AuditType.Information, GetType().Name + " - " + MethodBase.GetCurrentMethod().Name, "Berjaya padam data pengguna sistem.", 1, LoggerName, "");
            }
            catch (Exception ex)
            {
                result = new ReturnViewModel();
        ...
        public Task<List<ApplicationUser>> GetUserAsync(CancellationToken ct = default)
        {
        ...
        public async Task<ApplicationUser> ViewDetail(int id)
        {
            ...
            try
            {
                ...
                if (response.ReturnCode == 200)
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(dataString))
                    {
                        result = JsonConvert.DeserializeObject<ApplicationUser>(dataString);
                    }
                    await _cf.CreateAuditLog((int)AuditType.Information, GetType().Name + " - " + MethodBase.GetCurrentMethod().Name, "Papar maklumat terperinci pengguna sistem.", 1, LoggerName, "");
                }
                else
                {
                    await _cf.CreateAuditLog((int)AuditType.Error, GetType().Name + " - " + MethodBase.GetCurrentMethod().Name, "Ralat - Status Kod : " + response.ReturnCode, 1, LoggerName, "");
